      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            (0, _alert.showAlert)('success', 'You succesfully logged out.');
            _context2.next = 11;
            break;
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidG9iaWFzb2htYW4iLCJhIjoiY2w2bTRoeDJkMDAzMjNkcng5bmIyeTF4byJ9.wYGn3y-3Q4noQ3-XZE0YVA';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'succes') {
              (0, _alert.showAlert)('success', "You succesfully updated your ".concat(type.toUpperCase()));
            }
...
var stripe = Stripe('pk_test_51KVx7NGcYqGbpxzVb9l6dpPdqC91oZ12dR9tkDJRJFIgd9M5CjBT54ZiVEVuG9IspYlQJWeoqbBI5YR9yWhhuJfg00SZfDSmR3');
